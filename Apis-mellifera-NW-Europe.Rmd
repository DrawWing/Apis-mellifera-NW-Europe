...
New data collected for this study are available at Zenodo [@machlowska2026]. There are also used data from earlier studies [@oleksa2022; @tofilski2025]
...
Comparison with lineages dataset [@nawrocka2018]
...
pTabLong$gr = gsub("GB", "UK", pTabLong$gr)
...
countryLin$ISO = gsub("GB", "UK", countryLin$ISO)
