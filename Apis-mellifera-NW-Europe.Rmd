---
title: "Analysis of honey bee wing shape from northwestern Europe"
...
author: 
  ...
  - name: "Lars Kirkerud"
    affiliation: Norges Birøkterlag, Norway
  - name: "Per Kryger"
...
ggarrange(figAdmA, figAdmB, 
          labels = c("a", "b"), label.y = 1.05, 
          font.label = list(size = 12, face = "bold"),
          ncol = 2, nrow = 1, 
          widths = c(0.66, 0.33),
          common.legend = TRUE, legend = "top")
...
ggarrange(figAdmA, figAdmB, figMapClass,
          labels = c("a", "b", "c"), label.y = 1.2,
          font.label = list(size = 12, face = "bold"),
          ncol = 1, nrow = 3,
          heights = c(1, 1, 3),
          common.legend = TRUE, legend = "top" 
...
ggplot(data = dataMap) + geom_sf() + 
  geom_jitter(data = dataGeoSample[dataGeoSample$lineage == "A", ], 
              aes(x = longitude, y = latitude), width = 0.4, height = 0.4) + 
  coord_sf(xlim = c(xMin, xMax), ylim = c(yMin, yMax))

# map of lineage C
ggplot(data = dataMap) + geom_sf() + 
  geom_jitter(data = dataGeoSample[dataGeoSample$lineage == "C", ], 
              aes(x = longitude, y = latitude), width = 0.4, height = 0.4) + 
  coord_sf(xlim = c(xMin, xMax), ylim = c(yMin, yMax))

# map of lineage M
ggplot(data = dataMap) + geom_sf() + 
  geom_jitter(data = dataGeoSample[dataGeoSample$lineage == "M", ], 
              aes(x = longitude, y = latitude), width = 0.4, height = 0.4) + 
  coord_sf(xlim = c(xMin, xMax), ylim = c(yMin, yMax))

# map of lineage O
ggplot(data = dataMap) + geom_sf() + 
  geom_jitter(data = dataGeoSample[dataGeoSample$lineage == "O", ], 
              aes(x = longitude, y = latitude), width = 0.4, height = 0.4) + 
  coord_sf(xlim = c(xMin, xMax), ylim = c(yMin, yMax))
